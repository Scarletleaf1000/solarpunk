package me.scarletleaf1000.sunworks.recipe;

import me.scarletleaf1000.sunworks.Sunworks;
import me.scarletleaf1000.sunworks.recipe.custom.AlloySmelterRecipe;
import me.scarletleaf1000.sunworks.recipe.custom.AlloySmelterRecipeSerializer;
...
public class ModRecipes {
    public static final DeferredRegister<RecipeSerializer<?>> SERIALIZERS =
            DeferredRegister.create(Registries.RECIPE_SERIALIZER, Sunworks.MOD_ID);
    public static final DeferredRegister<RecipeType<?>> TYPES =
            DeferredRegister.create(Registries.RECIPE_TYPE, Sunworks.MOD_ID);
